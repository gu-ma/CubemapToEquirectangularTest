...
CubemapToEquirectangular.prototype.setSize = function( width, height ) {
	...
	// this.output = new THREE.WebGLMultisampleRenderTarget( this.width, this.height, {
	// 	minFilter: THREE.LinearFilter,
	// 	magFilter: THREE.LinearFilter,
	// 	wrapS: THREE.ClampToEdgeWrapping,
	// 	wrapT: THREE.ClampToEdgeWrapping,
...
CubemapToEquirectangular.prototype.getOutput = function( cubeCamera ) {
